<div class="bg-yellow-100 flex flex-col items-center justify-center space-y-12 p-32">
    <div class="text-6xl font-bold text-red-700">
        <h1 class="font-YesevaOne text-munamiidarkgreen">About us</h1>
    </div>
    <div class="text-3xl font-light text-left max-w-lg font-JosefinSans">
